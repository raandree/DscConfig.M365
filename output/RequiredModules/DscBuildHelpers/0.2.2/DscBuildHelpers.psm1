#Region '.\Private\Assert-DscModuleResourceIsValid.ps1' 0
...
#Region '.\Private\Get-RequiredModulesFromMOF.ps1' 0
...
#Region '.\Private\Resolve-ModuleMetadataFile.ps1' 0
...
#Region '.\Public\Clear-CachedDscResource.ps1' 0
...
#Region '.\Public\Compress-DscResourceModule.ps1' 0
...
#Region '.\Public\Find-ModuleToPublish.ps1' 0
...
#Region '.\Public\Get-DscCimInstanceReference.ps1' 0
...
#Region '.\Public\Get-DscFailedResource.ps1' 0
...
#Region '.\Public\Get-DscResourceFromModuleInFolder.ps1' 0
    ...
    process {
        ...
        $AllDscResource.Where{
            $isResourceInModulesToPublish = foreach ($Module in $Modules) {
                ...
                elseif (-not (compare-object -ReferenceObject $_.Module -DifferenceObject $Module -Property ModuleType, Version, Name) ) {
                    Write-Debug "Resource $($_.Name) matches one of the supplied Modules."
                    $true
                }
            }
            if (-not $isResourceInModulesToPublish) {
...
#Region '.\Public\Get-DscResourceProperty.ps1' 0
...
#Region '.\Public\Get-DscResourceWmiClass.ps1' 0
...
#Region '.\Public\Get-DscSplattedResource.ps1' 0
function Get-DscSplattedResource
{
    ...
    if ($script:allDscResourcePropertiesTable.Count -eq 0 -and -not $script:allDscResourcePropertiesTableWarningShown) {
...
#EndRegion '.\Public\Get-DscSplattedResource.ps1' 112
#Region '.\Public\Get-ModuleFromFolder.ps1' 0
...
#EndRegion '.\Public\Initialize-DscResourceMetaInfo.ps1' 61
...
#Region '.\Public\Publish-DscResourceModule.ps1' 0
...
#Region '.\Public\Push-DscModuleToNode.ps1' 0
<#
    .SYNOPSIS
...
#Region '.\Public\Remove-DscResourceWmiClass.ps1' 0
<#
    .Synopsis
...
#Region '.\Public\Test-DscResourceFromModuleInFolderIsValid.ps1' 0
