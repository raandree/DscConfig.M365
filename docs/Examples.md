...
```powershell
configuration M365_MultiWorkload_Example {
    param (
        [Parameter(Mandatory = $true)]
        [PSCredential]
        $Credential
    ...
    node localhost {
        ...
        cSPOTenantSettings TenantSettings {
            IsSingleInstance                  = 'Yes'
            MinCompatibilityLevel             = 16
            ExternalServicesEnabled           = $true
            StorageQuotaAllocated             = 5000000
...
For more examples and use cases, see the test configurations in the [tests directory](https://github.com/dsccommunity/DscConfig.M365/tree/main/tests/Unit/DSCResources/Assets/Config).
